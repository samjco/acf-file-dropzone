...
class acf_field_file_dropzone extends acf_field {
	...
	*/
    function input_admin_enqueue_scripts() {
        ...
        wp_register_script( 'mediaelement',  $this->settings . '/vendor/mediaelement/build/mediaelement-and-player.min.js', array('acf-input'), $this->settings['version'] );
        wp_register_script( 'dropzone',  $this->settings . '/vendor/dropzone/dist/min/dropzone.min.js', array('acf-input'), $this->settings['version'] );
        wp_register_script( 'acf-input-file-dropzone',  $this->settings . '/js/acf-file-dropzone.js', array('acf-input'), $this->settings['version'] );
        wp_register_style( 'dropzone-basic',  $this->settings . '/vendor/dropzone/dist/min/basic.min.css', array('acf-input'), $this->settings['version'] );
        wp_register_style( 'dropzone',  $this->settings . '/vendor/dropzone/dist/min/dropzone.min.css', array('acf-input'), $this->settings['version'] );
        wp_register_style( 'acf-input-file-dropzone',  $this->settings . '/css/style.css', array('acf-input'), $this->settings['version'] );
        wp_register_style( 'mediaelement',  $this->settings . '/vendor/mediaelement/build/mediaelementplayer.min.css', array('acf-input'), $this->settings['version'] );
